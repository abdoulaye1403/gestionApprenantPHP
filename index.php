    ...
    <table class="table">
       ...
       <tbody>
        ...
        <tr>
          ...
          <td><?php echo $apprenant['pays'];?></td>
          <td><?php echo $apprenant['genre'];?></td>
          <td class="text-center">
            <a class="btn btn-warning" href="edit.php?id=<?php echo $apprenant['id'];?>">Modifier</a>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h2 class="modal-title" id="exampleModalLabel">Ajouter nouveau apprenant</h2>
